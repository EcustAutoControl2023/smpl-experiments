...
algo_config_dict_location = (
    "ray_results/beerfmtenv/ppo/PPOTrainer/PPOTrainer_my_env/params.pkl"
)
...
agent.restore(
    "ray_results/beerfmtenv/ppo/PPOTrainer/PPOTrainer_my_env/checkpoint_002000/checkpoint-2000"
)
